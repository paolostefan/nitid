...
NITID_ARRAY_FROM_LIT_IMPL(i32)
NITID_ARRAY_FROM_LIT_IMPL(i64)
NITID_ARRAY_FROM_LIT_IMPL(i128)

NITID_ARRAY_FROM_LIT_IMPL(u8)
NITID_ARRAY_FROM_LIT_IMPL(u16)
NITID_ARRAY_FROM_LIT_IMPL(u32)
NITID_ARRAY_FROM_LIT_IMPL(u64)
NITID_ARRAY_FROM_LIT_IMPL(u128)

NITID_ARRAY_GET_IMPL(i8)
NITID_ARRAY_GET_IMPL(i16)
NITID_ARRAY_GET_IMPL(i32)
NITID_ARRAY_GET_IMPL(i64)
NITID_ARRAY_GET_IMPL(i128)

NITID_ARRAY_GET_IMPL(u8)
NITID_ARRAY_GET_IMPL(u16)
NITID_ARRAY_GET_IMPL(u32)
NITID_ARRAY_GET_IMPL(u64)
NITID_ARRAY_GET_IMPL(u128)

NITID_ARRAY_FROM_LIT_IMPL(f32)
NITID_ARRAY_FROM_LIT_IMPL(f64)
NITID_ARRAY_FROM_LIT_IMPL(bool)

NITID_ARRAY_GET_IMPL(f32)
NITID_ARRAY_GET_IMPL(f64)
NITID_ARRAY_GET_IMPL(bool)
