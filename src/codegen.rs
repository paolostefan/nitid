...
pub struct Codegen {
    ...
    /// Struct definitions (name, fields, packed, align, is_opaque) for emission.
    struct_defs: Vec<(String, Vec<StructField>, bool, Option<u64>, bool)>,
...
impl Codegen {
    ...
    pub fn generate_c(
        ...
        for (name, fields, packed, align, is_opaque) in &self.struct_defs {
